...
class AsteroidFactory extends Component
  ...
  List<Component> makeAsteroids() {
    return List<Component>.generate(
      20,
          (i) =>
          Asteroid(radius: 4 + Random().nextDouble() * 10,
              initialPosition: Vector2(Random().nextDouble() * 200 - 100, Random().nextDouble() * 200 - 100),
              initialSpeed: Vector2(Random().nextDouble() * 1 - 0.5, Random().nextDouble() * 1 - 0.5)),
    );
  }
}